...
* Footnotes
[fn:2] There are special registers for vector operations and floating point operations but we're going to just use the basic ones that old "integer-like" data 
